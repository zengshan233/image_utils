...
class H1 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H1({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
...
class H2 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H2({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Text(
...
class H3 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H3({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Text(
...
class H4 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H4({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Text(
...
class H5 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H5({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Text(
...
class H6 extends StatelessWidget {
  ...
  final Color? color;
  final String? text;
  const H6({Key? key, this.fontWeight, this.color, this.text})
      : super(key: key);
  @override
  Widget build(BuildContext context) {
    return Text(
